...
void CHalfLifeMultiplay::DeathNotice( CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pevInflictor )
{
	...
	const char *zapgun = "zapgun";
	const char *multizapper = "multizapper";
	const char *squidspit = "squidspit";
	const char *freezeray = "freezeray";
	const char *snarklauncher = "snarklauncher";
